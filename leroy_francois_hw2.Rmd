...
```{r}
## Function to randomly extract the test dataset in d_train using always the same number of positive and negative values of Purchase
prepare_cv_folds <-  function(k){
  # Create the subsets data containing Purchase == Yes in one hand and Purchase == No in an other hand
